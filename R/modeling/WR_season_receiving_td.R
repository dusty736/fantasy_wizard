...
modeling_data <- data.table::fread("data/processed/season/wr_season_stat_modeling_data.csv")
external_data <- data.frame(data.table::fread("data/processed/season/wr_season_external.csv"))
...
# Save
data.table::fwrite(player_df, "data/results/WR/exp_w_receiving_td_2023.csv")
